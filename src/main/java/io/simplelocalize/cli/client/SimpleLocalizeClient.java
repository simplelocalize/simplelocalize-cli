...
import io.simplelocalize.cli.util.ClientUtils;
...
import static io.simplelocalize.cli.util.ClientUtils.extractAccessToken;
import static io.simplelocalize.cli.util.ClientUtils.tryExtractMessage;
...
public final class SimpleLocalizeClient {
  ...
  public void pushKeys(String projectHash, Set<String> keys) throws IOException {
    ...
    int keysProcessed = JsonPath.read(responseJson, "$.data.uniqueKeysProcessed");
